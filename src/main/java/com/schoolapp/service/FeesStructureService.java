...
public class FeesStructureService {
	...
	public List<FeesStructure> saveFeesStructure(List<FeesStructure> FeesStructure) throws ClassNotFoundException, SQLException {
	...
	public List<FeesStructure> updateFeesStructure(List<FeesStructure> FeesStructureId) throws ClassNotFoundException, SQLException {
