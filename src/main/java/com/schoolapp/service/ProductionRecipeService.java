...
public class ProductionRecipeService {
	...
	public Object saveProductionRecipe(ProductionRecipe ProductionRecipe) throws ClassNotFoundException, SQLException {
	...
	public String getAllStudentClassWise(ProductionRecipe ProductionRecipe) throws Exception {
