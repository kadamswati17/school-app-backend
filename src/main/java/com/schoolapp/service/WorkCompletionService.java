...
public class WorkCompletionService {
	...
	public WorkCompletion saveWorkCompletion(WorkCompletion workCompletion) throws ClassNotFoundException, SQLException {
	...
	public WorkCompletion updateDeleteWorkCompletion(WorkCompletion workCompletion) throws ClassNotFoundException, SQLException {
		WorkCompletion path = null;
		int userId = workCompletion.getUserId();
