...
public class ClassMasterService {
	...
	public ClassMaster saveClassMaster(ClassMaster ClassMaster) throws ClassNotFoundException, SQLException {
...
//		Integer c = ClassMasterId.getClassMasterId();
//		ClassMaster ClassMaster = ClassMasterDao.findClassMasterById(ClassMasterId.getClassMasterId());
//		ClassMaster.setClassMasterId(ClassMasterId.getClassMasterId());
//		ClassMaster.setClassMasterName(ClassMasterId.getClassMasterName());
//		ClassMaster.setDistId(ClassMasterId.getDistId());
//		ClassMaster.setStateId(ClassMasterId.getStateId());
