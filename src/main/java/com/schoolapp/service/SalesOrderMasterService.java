...
public class SalesOrderMasterService {
	...
	public SalesOrderMaster saveSalesMst(SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
...
//		System.out.println(valideSave);
	...
	public String getAllSalesMst(SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
	...
	public SalesOrderMaster updateSales(SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
