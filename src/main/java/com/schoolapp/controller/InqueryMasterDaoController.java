...
public class InqueryMasterDaoController {
	...
	@PostMapping("/save")
	public String saveInqueryMaster(@RequestBody InqueryMaster inqueryMaster) throws ClassNotFoundException, SQLException {
	...
	public String updateDeleteContractor(@RequestBody InqueryMaster inqueryMaster) throws ClassNotFoundException, SQLException {
