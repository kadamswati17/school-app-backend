...
public class ReasourceMasterController {
	...
	@PostMapping("/save")
	public String saveReasourceMaster(@RequestBody ReasourceMaster ReasourceMaster) throws ClassNotFoundException, SQLException {
		ReasourceMasterService.saveReasourceMaster(ReasourceMaster);
		return "Record save successfully";
	}

	@PostMapping("/getAll")
	public String getAllReasourceMaster(@RequestBody ReasourceMaster ReasourceMaster) throws ClassNotFoundException, SQLException {
