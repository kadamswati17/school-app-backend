...
public class QuotationMasterController {
	...
	@PostMapping("/save")
	public String saveQuotationMaster(@RequestBody QuotationMaster quotationMaster) throws ClassNotFoundException, SQLException {
		quotationMasterService.saveQuotationMst(quotationMaster);
		return "Record save successfully";
	}

	@PostMapping("/getAll")
	public String getAllQuotationMaster(@RequestBody QuotationMaster quotationMaster) throws ClassNotFoundException, SQLException {
	...
	public String updateDeleteContractor(@RequestBody QuotationMaster quotationMaster) throws ClassNotFoundException, SQLException {
		quotationMasterService.updateDeleteQuotationMaster(quotationMaster);
		return "Record Updated.....";
	}

	@PutMapping("/update")
	public String updateQuotation(@RequestBody QuotationMaster quotationMaster) throws ClassNotFoundException, SQLException {
