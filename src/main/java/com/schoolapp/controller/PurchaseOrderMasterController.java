...
public class PurchaseOrderMasterController {
	...
	@PostMapping("/save")
	public String savePurchaseOrderMaster(@RequestBody PurchaseOrderMaster purchaseOrderMaster) throws ClassNotFoundException, SQLException {
		purchaseOrderMasterService.savePurchaseMst(purchaseOrderMaster);
		return "Record save successfully";
	}

	@PostMapping("/getAll")
	public String getAllPurchaseOrderMaster(@RequestBody PurchaseOrderMaster purchaseOrderMaster) throws ClassNotFoundException, SQLException {
	...
	public String updateDeleteContractor(@RequestBody PurchaseOrderMaster purchaseOrderMaster) throws ClassNotFoundException, SQLException {
		purchaseOrderMasterService.updateDeletePurchaseOrderMaster(purchaseOrderMaster);
		return "Record Updated.....";
	}

	@PutMapping("/update")
	public String updatePurchase(@RequestBody PurchaseOrderMaster purchaseOrderMaster) throws ClassNotFoundException, SQLException {
