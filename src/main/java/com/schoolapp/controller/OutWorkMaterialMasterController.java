...
public class OutWorkMaterialMasterController {
	...
	@PostMapping("/save")
	public String saveOutWorkMaterialMaster(@RequestBody OutWorkMaterialMaster OutWorkMaterialMaster) throws ClassNotFoundException, SQLException {
		OutWorkMaterialMasterService.saveOutWorkMaterialMaster(OutWorkMaterialMaster);
		return "Record save successfully";
	}

	@PostMapping("/getAll")
	public String getAllOutWorkMaterialMaster(@RequestBody OutWorkMaterialMaster OutWorkMaterialMaster) throws Exception {
	...
	@PutMapping("/update")
	public OutWorkMaterialMaster updateDeleteOutWorkMaterialMaster(@RequestBody OutWorkMaterialMaster OutWorkMaterialMaster) throws ClassNotFoundException, SQLException {
	...
	public String deleteOutWorkMaterialMasterById(@RequestBody OutWorkMaterialMaster OutWorkMaterialMaster) {
		OutWorkMaterialMasterService.deleteOutWorkMaterialMasterById(OutWorkMaterialMaster.getOutWorkMaterialMasterId());
		return "deleted............";
	}
}
