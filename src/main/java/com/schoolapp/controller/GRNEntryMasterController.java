...
public class GRNEntryMasterController { 
	...
	@PostMapping("/save")
	public String saveGRNEntryMaster(@RequestBody GRNEntryMaster GRNEntryMaster) throws ClassNotFoundException, SQLException {
	...
	@PutMapping("/update")
	public GRNEntryMaster updateDeleteGRNEntryMaster(@RequestBody GRNEntryMaster GRNEntryMaster) throws ClassNotFoundException, SQLException {
