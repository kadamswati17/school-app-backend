...
public class FeesStructureController {
	...
	@PostMapping("/save")
	public String saveFeesStructure(@RequestBody List<FeesStructure> FeesStructure) throws ClassNotFoundException, SQLException {
		FeesStructureService.saveFeesStructure(FeesStructure);
		return "Record save successfully";
	}

	@PostMapping("/getAll")
	public  String getAllFeesStructure(@RequestBody FeesStructure FeesStructure) throws ClassNotFoundException, SQLException {
	...
	@PutMapping("/update")
	public String updateFeesStructure(@RequestBody List<FeesStructure> FeesStructure) throws ClassNotFoundException, SQLException {
