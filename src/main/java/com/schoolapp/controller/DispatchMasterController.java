...
public class DispatchMasterController {
	...
	@PostMapping("/save")
	public String saveDispatchMaster(@RequestBody DispatchMaster DispatchMaster) throws ClassNotFoundException, SQLException {
	...
	@PutMapping("/update")
	public DispatchMaster updateDeleteDispatchMaster(@RequestBody DispatchMaster DispatchMaster) throws ClassNotFoundException, SQLException {
