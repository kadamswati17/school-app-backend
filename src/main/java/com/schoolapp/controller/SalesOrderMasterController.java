...
public class SalesOrderMasterController {
	...
	@PostMapping("/save")
	public String saveSalesOrderMaster(@RequestBody SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
		salesOrderMasterService.saveSalesMst(salesOrderMaster);
		return "Record save successfully";
	}

	@PostMapping("/getAll")
	public String getAllSalesOrderMaster(@RequestBody SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
	...
	public String updateDeleteContractor(@RequestBody SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
		salesOrderMasterService.updateDeleteSalesOrderMaster(salesOrderMaster);
		return "Record Updated.....";
	}

	@PutMapping("/update")
	public String updateSales(@RequestBody SalesOrderMaster salesOrderMaster) throws ClassNotFoundException, SQLException {
