...
public class OrganizationController {
	...
	@PostMapping("/save")
	public Organization saveLeadAccounts(@RequestBody Organization organization) throws ClassNotFoundException, SQLException {
	...
	@PutMapping("/update")
	public String updateLeadAccounts(@RequestBody Organization organization) throws ClassNotFoundException, SQLException {
