...
public class Organization {
	...
	public Organization(int orgId, Date date, String orgName, String ownerName, String ownerContact, String panNo,
			...
			int isActive, int stateId, int distId, int cityId, int userId, Date createdDate, int updatedBy,
			Date updatedDate, int customerId, String uDiskId, String regId) {
		super();
		this.orgId = orgId;
		this.date = date;
	...
	public String toString() {
		return "Organization [orgId=" + orgId + ", date=" + date + ", orgName=" + orgName + ", ownerName=" + ownerName
				...
				+ updatedBy + ", updatedDate=" + updatedDate + ", customerId=" + customerId + ", uDiskId=" + uDiskId
				+ ", regId=" + regId + "]";
	}
