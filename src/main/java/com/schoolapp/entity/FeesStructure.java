...
public class FeesStructure {
	...
	public FeesStructure(int feesStructureId, int classId, int reasourceId, int financeYear, int charges, Date trDate,
			int isActive, int userId, int branchId, int orgId, Date createdDate, int updatedBy, Date updatedDate) {
		super();
	...
	public String toString() {
		return "FeesStructure [feesStructureId=" + feesStructureId + ", classId=" + classId + ", reasourceId="
				+ reasourceId + ", financeYear=" + financeYear + ", charges=" + charges + ", trDate=" + trDate
				+ ", isActive=" + isActive + ", userId=" + userId + ", branchId=" + branchId + ", orgId=" + orgId
