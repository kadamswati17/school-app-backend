...
public class Customer {
	...
	public Customer(int custId, Date date, String custName, String ownerName, String ownerContact, String panNo,
			String gstNo, String email, String website, String phone, int fax, String invoiceAddress, int income,
			String incomeSource, int otherIncome, String otherIncomeSource, int budget1, int budget2, String notes,
			int isActive, int stateId, int orgId, int distId, int cityId, int userId, Date createdDate, int updatedBy,
			Date updatedDate) {
		super();
		this.custId = custId;
		this.date = date;
	...
	public String toString() {
		return "Customer [custId=" + custId + ", date=" + date + ", custName=" + custName + ", ownerName=" + ownerName
				...
				+ ", notes=" + notes + ", isActive=" + isActive + ", stateId=" + stateId + ", orgId=" + orgId
				+ ", distId=" + distId + ", cityId=" + cityId + ", userId=" + userId + ", createdDate=" + createdDate
