...
public class SalesOrder {
	...
	public SalesOrder(int salesOrderId, Date salesDate, int salesOrderMstId, int customerId, int productId,
		...
		this.salesOrderMstId = salesOrderMstId;
	...
	public int getSalesOrderMstId() {
		return salesOrderMstId;
	}

	public void setSalesOrderMstId(int salesOrderMstId) {
		this.salesOrderMstId = salesOrderMstId;
	}
	...
	public String toString() {
		return "SalesOrder [salesOrderId=" + salesOrderId + ", salesDate=" + salesDate + ", salesOrderMstId="
				+ salesOrderMstId + ", customerId=" + customerId + ", productId=" + productId + ", product=" + product
